...
set CLASSPATH=%APP_HOME%\lib\assignment4-1.0-SNAPSHOT.jar;%APP_HOME%\lib\json-simple-1.1.1.jar;%APP_HOME%\lib\junit-4.10.jar;%APP_HOME%\lib\hamcrest-core-1.1.jar

@rem Execute assignment4
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ASSIGNMENT4_OPTS%  -classpath "%CLASSPATH%" UserInterface %CMD_LINE_ARGS%
